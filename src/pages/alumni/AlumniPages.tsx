...
export function AlumniNetwork() {
  const alumni = [
    { name: 'Dr. Wanjiku Muthoni', class: 'MBChB 2026', role: 'Medical Advisor, World Health Organization Regional Office for Africa (Nairobi)', img: '' },
    { name: 'Dr. Odhiambo Kipchoge', class: 'MSc Biomedical 2026', role: 'Senior Researcher, Africa Population and Health Research Centre (Nairobi)', img: '' },
    { name: 'Nurse Amina Otieno', class: 'BNSc 2026', role: 'District Health Director, Kakamega County', img: '' },
    { name: 'Dr. Peter Ngugi', class: 'MBChB 2026', role: 'Chief Medical Officer, Moi Teaching Hospital', img: '' },
    { name: 'Dr. Grace Aloo', class: 'CNA 2026', role: 'Regional Caregiver, Homa Bay County', img: '' },
    { name: 'Dr. Faith Chebet', class: 'BNSc 2026', role: 'Community Health Director, Mombasa County', img: '' },
  ]

  return (
    <>
      <PageHeroSimple title={<>Alumni <em>Network</em></>} sub="Blue West healers working across Kenyan counties — all connected by a shared commitment to health excellence and community service." img="https://images.unsplash.com/photo-1627556704302-624286467c65?w=1600&q=80&fit=crop" crumbs={['Alumni', 'Alumni Network']} />
      <section className="section section-alt-bg">
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '5rem' }} className="alumni-stats-resp">
            {[['30+', 'Alumni'], ['5+', 'Counties Represented'], ['2026', 'First Graduating Class'], ['97%', 'Graduate Employment Rate']].map(([n, l]) => (
          ...
          <div style={{ marginTop: '5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem', marginTop: '2rem' }}>
              {[
                { icon: '🤝', title: 'Network Access', desc: 'Connect with 30+ alumni across 5+ counties via our private digital platform, annual reunions, and regional chapter events in Nairobi, and other counties.' },
      ...
      <section className="section section-alt-bg">
        <div className="container">
          {[
            ...
            { name: 'Makena Hall (Block B)', capacity: 200, type: 'Female-only, single rooms', amenities: ['Ensuite bathroom', 'Kitchenette', 'Female-only gym', 'Prayer room', 'Study pods'], img: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=700&q=80&fit=crop', fee: 'KSh 40,000/semester' },
