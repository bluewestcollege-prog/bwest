...
const leadership = [
  { img: '', name: 'Prof. Grace Wambui, PhD', title: 'Principal & Vice Chancellor', bio: 'A celebrated epidemiologist and public health leader, Prof. Wambui has led Blue West since 2018, overseeing a 60% growth in enrolment and launching three new research centres. She holds a PhD from Johns Hopkins and an honorary doctorate from the University of Nairobi.', dept: 'Office of the Principal' },
  { img: '', name: 'Dr. Samuel Odhiambo', title: 'Dean of Clinical Sciences', bio: 'With 22 years of clinical and academic experience at Moi Teaching & Referral Hospital, Dr. Odhiambo is the architect of our acclaimed clinical training curriculum, which has been adopted by three other Kenyan medical schools.', dept: 'Faculty of Clinical Medicine' },
  { img: '', name: 'Prof. Amina Hassan', title: 'Dean of Research & Postgraduate Studies', bio: 'Prof. Hassan leads our research enterprise with over 140 peer-reviewed publications and active grants from WHO, Wellcome Trust, and the Kenya National Research Fund. Her work on malaria diagnostics is cited globally.', dept: 'School of Biomedical Sciences' },
  { img: '', name: 'Dr. Peter Mutembei', title: 'Dean of Student Affairs', bio: 'Dr. Mutembei champions student welfare, mental health, and community outreach at Blue West. Under his leadership, the college established Kenya\'s first medical student rural placement programme.', dept: 'Student Affairs Directorate' },
  { img: '', name: 'Dr. John Kipkorir', title: 'Head of School of Pharmacy', bio: 'Dr. Kipkorir holds a PharmD from Strathmore and specialises in tropical medicine pharmacology. He has established key partnerships with Revital Healthcare and other Kenya-based pharma firms for student internships.', dept: 'School of Pharmacy & Pharmacology' },
  { img: '', name: 'Dr. Faith Achieng', title: 'Head of School of Nursing & Midwifery', bio: 'An award-winning nurse educator, Dr. Achieng led the redesign of the BNSc curriculum to integrate community health nursing, a critical need in rural Kenya. She is a WHO nursing expert panel member.', dept: 'School of Nursing & Midwifery' },
  { img: '', name: 'Ms. Caroline Njoroge', title: 'Registrar & Academic Affairs', bio: 'Ms. Njoroge oversees admissions, examinations, and all academic records. With 18 years in higher education administration, she has modernised the college\'s enrolment and records management systems.', dept: 'Academic Registrar\'s Office' },
  { img: '', name: 'Mr. David Rotich', title: 'Director of Finance & Strategy', bio: 'Mr. Rotich oversees the college\'s financial sustainability and strategic investments. He led the capital campaign that funded the new KSh 300M Waweru Simulation Centre and the growing scholarship endowment.', dept: 'Finance & Strategy' },
]
